...
//
const char* SSID = "Beanos";        // Enter your Wi-Fi name
const char* PASSWORD = "ruby5117";  // Enter your Wi-Fi password
//
// ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
// ====================================================================
...
char* const inputToken = "Superidol2_input";
char* const outputToken = "Superidol2_output";
